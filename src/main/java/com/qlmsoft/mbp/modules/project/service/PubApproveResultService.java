...
public class PubApproveResultService extends CrudService<PubApproveResultDao, PubApproveResult> {
	...
	public Page<PubApproveResult> findPage(Page<PubApproveResult> page, PubApproveResult pubApproveResult) {
