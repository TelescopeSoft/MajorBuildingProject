						...
						<div class="col-xs-12">
							<div class="box">
								<div class="box-header">
									<div class="approvetitle">施工许可信息公示</div>
								</div>
								<div class="box-body">
    ...
    $(function () {
        ...
        $('#constructionTable').DataTable({
	        ...
	        "columns": [
	            ...
	            { "data": "area" },
	            { "data": "prjsize" },
	            { "data": function(obj){ var day = moment(obj.issuecertdate);return day.format("YYYY-MM-DD")} },
	            { "data": "econcorpname" },
	            { "data": "designcorpname" },
	            { "data": "conscorpname" },
	            { "data": "supercorpname" },
	            { "data": "constructorname" },
	            { "data": "supervisionname" }
	        ],
            'language': {
                "sProcessing": "处理中...",
