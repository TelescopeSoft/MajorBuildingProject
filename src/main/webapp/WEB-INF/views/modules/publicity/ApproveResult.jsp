            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box">
                        ...
                        <!-- form start -->
                <form:form role="form" modelAttribute="approveresult"  action="${ctx}/publicity/approveresult" method="post">
                    <div class="box-body">
                        <div class="row form-group">
                            <div class="col-xs-3">
                                <form:input class="form-control" placeholder="项目代码" path="prjCode" />
                            </div>
                            <div class="col-xs-4">
                                <form:input class="form-control" placeholder="项目名称" path="prjName" />
                            </div>
                            <div class="col-xs-4">
                                <form:input class="form-control" placeholder="审批事项" path="approveItemLabel" />
                            </div>
                            
                        </div>
                        <div class="row form-group">
                            <div class="col-xs-3">
                                <form:input class="form-control" placeholder="审批部门" path="approveDept" />
                            </div>
                            <!-- <div class="col-xs-3">
                            	<input type="text" class="form-control" placeholder="审批结果" name="prjCode">
