...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/project/apAjsbb/">安监申报列表</a></li>
		<li class="active"><a href="${ctx}/project/apAjsbb/form?id=${apAjsbb.id}">安监申报<shiro:hasPermission name="project:apAjsbb:edit">${not empty apAjsbb.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="project:apAjsbb:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="apAjsbb" action="${ctx}/project/apAjsbb/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>		
		<div class="control-group">
			<label class="control-label">安监申报表编号：</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label">安监项目名称：</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label">安监申报表编号	c5dd7ed0-1a98-4443-8c63-7a25964be842	安监项目名称	江阴市人民法院霞客人民法庭审判业务用房（装修装饰工程） 项目编号	3202811507200102	立项项目名称	江阴市人民法院霞客人民法庭审判业务用房 安全监督机构名称：</label>
			<div class="controls">
				<form:input path="ajjgmc" htmlEscape="false" maxlength="200" class="input-xlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">AJ320281-1：</label>
			<div class="controls">
				<form:input path="ajcorpcode" htmlEscape="false" maxlength="18" class="input-xlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			<label class="control-label">项目分类小类：</label>
			<div class="controls">
				<form:input path="sprjtypenum" htmlEscape="false" maxlength="100" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="createdate" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate required"
					value="<fmt:formatDate value="${apAjsbb.createdate}" pattern="yyyy-MM-dd HH:mm:ss"/>"
		...
		<div class="control-group">
			<label class="control-label">是否是保障房：</label>
			<div class="controls">
				<form:input path="sfbz" htmlEscape="false" maxlength="50" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">坐标经度：</label>
			<div class="controls">
				<form:input path="jdz" htmlEscape="false" class="input-xlarge  number"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">坐标纬度：</label>
			<div class="controls">
				<form:input path="wdz" htmlEscape="false" class="input-xlarge  number"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">项目面积：</label>
			<div class="controls">
				<form:input path="mj" htmlEscape="false" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">项目造价：</label>
			<div class="controls">
				<form:input path="zj" htmlEscape="false" class="input-xlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">结构层次：</label>
			<div class="controls">
				<form:input path="jgcc" htmlEscape="false" maxlength="200" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">申报目标：</label>
			<div class="controls">
				<form:input path="sbmb" htmlEscape="false" maxlength="100" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">是否符合安装远程监控条件：</label>
			<div class="controls">
				<form:input path="sfjk" htmlEscape="false" maxlength="50" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">施工许可证号：</label>
			<div class="controls">
				<form:input path="sgxkz" htmlEscape="false" maxlength="50" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="fetchdate" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate required"
					value="<fmt:formatDate value="${apAjsbb.fetchdate}" pattern="yyyy-MM-dd HH:mm:ss"/>"
					onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',isShowClear:false});"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<input name="updatetime" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate required"
					value="<fmt:formatDate value="${apAjsbb.updatetime}" pattern="yyyy-MM-dd HH:mm:ss"/>"
					onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',isShowClear:false});"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="updatedate" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
					value="<fmt:formatDate value="${apAjsbb.updatedate}" pattern="yyyy-MM-dd HH:mm:ss"/>"
					onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',isShowClear:false});"/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			<shiro:hasPermission name="project:apAjsbb:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
