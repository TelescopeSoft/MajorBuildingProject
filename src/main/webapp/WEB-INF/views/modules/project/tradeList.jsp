...
<body>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="trade">
			<tr>
				<td><a href="${ctx}/project/trade/form?id=${trade.id}">
					${trade.prjName}
				</a></td>
				<td>
				...
				<td>
					<fmt:formatDate value="${trade.writetime}" pattern="yyyy-MM-dd HH:mm:ss"/>
				</td>
				<td>
					<fmt:formatDate value="${trade.opentime}" pattern="yyyy-MM-dd HH:mm:ss"/>
				</td>
				<td>
					${trade.indexid}
				</td>
